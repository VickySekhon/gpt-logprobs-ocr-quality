# python scan2latex_entropy.py --top-k 1 --window-size 5 --top-m 10 "Images/2106.13823v3-P3-300.jpg"

# python scan2latex_entropy.py -h

#!/usr/bin/env python3
import os, sys, time, math, base64, argparse, heapq
...
parser = argparse.ArgumentParser(
    description=("Convert a scanned page to LaTeX (auto-adds a standard "
...
parser.add_argument("image", help="Path to the JPEG/PNG/PDF page to process")
parser.add_argument("--top-k",      type=int, default=5,  metavar="K",
                    help="Number of alternative tokens to request (1–20).")
parser.add_argument("--window-size", type=int, default=20, metavar="W",
                    help="Sliding-window size in tokens.")
parser.add_argument("--top-m",      type=int, default=3,  metavar="M",
...
system_prompt = (
    ...
    "expression and repair typical OCR artefacts. Preserve prose verbatim. "
...
tok_infos = [
    t for t in choice.logprobs.content
