...
def verify_dataset_exists():
     ...
     for file_path in [ground_truth_path, image_path, ocr_path]:
          if not os.path.exists(file_path):     
               error_string = f"'{file_path}' does not exist or is not named correctly. Follow instructions in '{readme_path}' to obtain dataset from online, or if it is already downloaded ensure that it is named correctly."
